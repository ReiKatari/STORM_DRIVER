$tempDir = 'E:\STORM SWITCH 4\STORM DRIVER\Build\stage_driver_401'
...
$zipOut1 = 'E:\STORM SWITCH 4\Files\STORM_DRIVER_4.0.1.zip'
$zipOut2 = 'E:\STORM DRIVER\STORM_DRIVER_4.0.1.zip'
...
$zipOut3 = "$zipDir3\STORM_DRIVER_4.0.1.zip"
...
Get-Item $zipOut1, $zipOut2, $zipOut3 | Select-Object Name, Length, LastWriteTime, Directory
