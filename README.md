...
- **STORM DRIVER 4.0.1 — Повышенная стабильность и совместимость**: восстановлен эталонный пайплайн ожидания завершения тайлов (`tu_drop_tile_wfi="true"`), интегрированы оптимизации WinNative 1.15 и Amaral 4.6.1.5, добавлены изолированные профили для *Dispatch*, *Dave the Diver*, *Brotato* и устранены графические артефакты.
