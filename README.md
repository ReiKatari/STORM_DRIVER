...
- **STORM DRIVER 4.0.4 — Монолитная стабильность GMEM и универсальная совместимость**: монолитная архитектурная стабилизация конвейера тайлинга Turnip GMEM, обеспечивающая идеальную и стабильную работу игры Dispatch (устранение любых мерцаний кнопок и полное восстановление рендеринга баннеров и контента DLC), эталонная совместимость с Adreno 6xx/7xx/8xx, ускоренный конвейер компиляции шейдеров NIR/IR3 и компрессия кэша Zstandard.
